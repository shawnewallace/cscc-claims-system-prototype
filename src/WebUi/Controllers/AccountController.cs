...
namespace EDeviceClaims.WebUi.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    private void SetProfileCache(string email)
    {
      ...
      //cache the username
      Session[UiConstants.USER_FIRST_NAME_SESSION_KEY] = profile.FirstName;
      Session[UiConstants.USER_LAST_NAME_SESSION_KEY] = profile.LastName;
    }
    ...
    public ActionResult LogOff()
    {
      ...
      Session[UiConstants.USER_FIRST_NAME_SESSION_KEY] = string.Empty;
      Session[UiConstants.USER_LAST_NAME_SESSION_KEY] = string.Empty;
      return RedirectToAction("Index", "Home");
    }
